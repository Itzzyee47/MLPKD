...
from utils.db import get_user, get_profile, upsert_profile, get_vitals, update_user
...
def show():
    ...
    with tab4:
        ...
        with st.form(key="patient_account_form"):
            col_a1, col_a2 = st.columns(2)
            acc_name     = col_a1.text_input("Display Name", value=user.get("name", ""))
